                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <?= $this->Html->link(__('View'), ['action' => 'view', $categoria->id], ['class'=>'btn btn-default btn-xs']) ?>
                                <?= $this->Html->link(__('Edit'), ['action' => 'edit', $categoria->id], ['class'=>'btn btn-primary btn-xs']) ?>
